...
export function generateDebugHTML() {
  return `
    ...
    <div class="panel">
      📊 Status</h2>
      <div id="fps-display" style="font-family; font-size; margin-bottom; color: #10b981;">FPS: --</div>
      <div id="debug-status">Loading...</div>
      <div class="btn-row" style="margin-top;">
    ...
    <div class="panel">
      💨 Wind & Gusts</h2>
        ...
        <span class="slider-label">Gust Intensity</span><span id="gust-value">1.0</span></span>
      ...
      <div class="btn-row">
        ...
        <span class="slider-label">Base Wind Speed</span><span id="wind-value">1.0</span></span>
    ...
    <div class="panel">
      ...
      <div class="btn-row">
        ...
        <span class="slider-label">Dance Intensity</span><span id="dance-value">1.0</span></span>
        <input type="range" id="dance-intensity" min="0.1" max="3" step="0.1" value="1">
      </label>
      
        <span class="slider-label">Dance Duration (seconds)</span><span id="dance-duration-value">10</span></span>
    ...
    <div class="panel">
      🌿 Vine & Crown</h2>
        ...
        <span class="slider-label">Vine Growth</span><span id="growth-value">1.0</span></span>
    ...
    <div class="panel">
      ...
      <div class="btn-row">
        ...
        Custom Command:
        <input type="text" id="custom-command" placeholder="e.g. wiggle" style="flex; padding; background: #0f172a; border: 1px solid #475569; border-radius; color;">
      </label>
    ...
    <div class="panel">
      🎨 Display Options</h2>
        ...
        <span class="slider-label">Global Scale</span><span id="scale-value">1.0</span></span>
    ...
    <div class="panel">
      ...
      <p style="font-size; color: #64748b; margin-top;">
    ...
    <div class="panel" style="min-width: 100%; max-width: 100%;">
      📟 Quick Console</h2>
      <p style="font-size; color: #64748b; margin: 0 0 8px 0;">
        Copy-paste commands for browser console (F12):
      </p>
      <div style="display; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap;">
        <code style="background: #0f172a; padding; border-radius; font-size; cursor;" title="Click to copy" data-copy="gardenDebug.bulkSpawn(50)">gardenDebug.bulkSpawn(50)</code>
        <code style="background: #0f172a; padding; border-radius; font-size; cursor;" title="Click to copy" data-copy="gardenDebug.spawnTestHeart()">gardenDebug.spawnTestHeart()</code>
        <code style="background: #0f172a; padding; border-radius; font-size; cursor;" title="Click to copy" data-copy="gardenDebug.startDance()">gardenDebug.startDance()</code>
        <code style="background: #0f172a; padding; border-radius; font-size; cursor;" title="Click to copy" data-copy="gardenDebug.forceGust(3)">gardenDebug.forceGust(3)</code>
        <code style="background: #0f172a; padding; border-radius; font-size; cursor;" title="Click to copy" data-copy="EventBus.emit(GardenEvents.RAID, { viewers: 100 })">EventBus.emit(GardenEvents.RAID, { viewers: 100 })</code>
        <code style="background: #0f172a; padding; border-radius; font-size; cursor;" title="Click to copy" data-copy="EventBus.emit(GardenEvents.GIFT_BOMB, { count: 10 })">EventBus.emit(GardenEvents.GIFT_BOMB, { count: 10 })</code>
      </div>
    </div>
  `;
}
